...
function AlertDialogPositioner({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
...
function AlertDialogContent({
    ...
    const contentPropsWithOutsidePointerEventsEnabled = {
        ...
        <AlertDialogPortal>
            ...
            <AlertDialogPositioner>
                <AlertDialogPrimitive.Content
                    ...
                    {...(contentPropsWithOutsidePointerEventsEnabled as any)}
                    {...props}
                >
                    <AlertDialogScrollLock />
                    {props.children}
                </AlertDialogPrimitive.Content>
            </AlertDialogPositioner>
        </AlertDialogPortal>
...
function AlertDialogScrollLock() {
    useDialogAppScrollLock();
    return null;
}
