...
export function useAccessControlAssignmentsQuery(): UseQueryResult<
...
> {
    ...
    return useQuery({
        queryKey: ACCESS_CONTROL_QUERY_KEYS.assignments(),
        queryFn: () => getAccessControlAssignments(apiClient),
