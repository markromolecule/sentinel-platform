...
export const instructorSubjectEnrollmentSchema = z.object({
    ...
    section_ids: z.array(z.string().uuid("Invalid section ID")).min(1, "At least one section must be selected"),
});

export type InstructorSubjectEnrollmentFormValues = z.infer<typeof instructorSubjectEnrollmentSchema>;
