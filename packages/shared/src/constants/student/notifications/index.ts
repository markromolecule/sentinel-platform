import { Notification } from '../../../types/student/notifications';
...
export const MOCK_NOTIFICATIONS: Notification[] = [
    {
        ...
        message:
            'Your exam for Advanced Mathematics is scheduled for tomorrow at 10:00 AM. Please ensure your environment is ready.',
        type: 'exam',
        priority: 'high',
        isRead: false,
    ...
    },
    {
        ...
        message:
            'The Sentinel platform will undergo scheduled maintenance on Saturday from 2:00 AM to 4:00 AM.',
        type: 'system',
        priority: 'medium',
        isRead: true,
