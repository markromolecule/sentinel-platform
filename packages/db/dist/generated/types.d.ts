...
export declare const proctor_assignment_status: {
    readonly PENDING: "PENDING";
...
export type proctor_assignment_status = (typeof proctor_assignment_status)[keyof typeof proctor_assignment_status];
export declare const announcement_status: {
    readonly DRAFT: "DRAFT";
    readonly PUBLISHED: "PUBLISHED";
    readonly SCHEDULED: "SCHEDULED";
    readonly ARCHIVED: "ARCHIVED";
