-- Assign a default institution to the Superadmin if they don't have one
-- This enables full CRUD operations for the Superadmin account
...
-- Ensure the Superadmin has a profile record if missing
