...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "exams_class_group_id_idx" ON "public"."exams"("class_group_id");
...
-- Backfill exams.class_group_id when the subject, section, institution, and subject term
-- resolve to exactly one existing class group.
