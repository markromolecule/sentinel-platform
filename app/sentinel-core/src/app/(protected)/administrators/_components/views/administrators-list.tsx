...
import { columns } from '@/app/(protected)/administrators/_components/tables/columns';
import { EditAdminDialog } from '@/app/(protected)/administrators/_components/dialogs/edit-admin-dialog';
