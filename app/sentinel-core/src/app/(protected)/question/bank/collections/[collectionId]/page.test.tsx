...
vi.mock('@/app/(protected)/question/bank/_components/tables/questions-table', () => ({
    QuestionsTable: (props: unknown) =>
        QuestionsTableMock(props as { onEdit: (question: { id: string }) => void }),
}));

vi.mock('@/app/(protected)/question/bank/_components/dialogs/import-modal', () => ({
    ImportModal: () => null,
}));
...
vi.mock('@/app/(protected)/question/bank/_components/views/questions-empty-state', () => ({
