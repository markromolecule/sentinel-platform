...
export const columns: ColumnDef<Room>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            let badgeStyles = 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20';
            let label = 'Available';

            if (status === 'ASSIGNED') {
                badgeStyles = 'bg-blue-500/10 text-blue-500 border border-blue-500/20';
                label = 'Assigned';
            } else if (status === 'MAINTENANCE') {
                badgeStyles = 'bg-amber-500/10 text-amber-500 border border-amber-500/20';
                label = 'Maintenance';
            }
