...
import { columns } from '@/app/(protected)/semesters/_components/tables/columns';
import { SemestersEmptyState } from '@/app/(protected)/semesters/_components/views/semesters-empty-state';
import { SEMESTER_OPTIONS } from '@/app/(protected)/semesters/_components/dialogs/constants';
