    ...
    const QUICK_LINKS = [
        {
            ...
            description: 'Track and analyze student incident trends, severity distributions, and high-frequency violation types across all exams.',
        ...
        },
        {
            ...
            description: 'Analyze real-time exam completion metrics, total volumes, and computed drop/completion rate trends.',
        ...
        },
        {
            ...
            description: 'View structural department-level integrity ratings, comparison matrix tables, and academic unit compliance indexes.',
        ...
        },
        {
            ...
            description: 'Generate, filter, and download printable analytical reports for administrative audits and institution records.',
