    ...
    return (
        ...
        >
            <div
                {...attributes}
                {...listeners}
                className="bg-background/80 hover:bg-accent text-muted-foreground absolute top-4 right-4 z-40 flex h-7 w-7 cursor-grab items-center justify-center rounded-md border shadow-xs transition-colors active:cursor-grabbing"
