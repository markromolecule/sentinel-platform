...
export const columns = (
...
): ColumnDef<InstructorAssignment>[] => [
    {
    ...
    },
    {
        ...
        header: ({ column }) => <DataTableColumnHeader column={column} title="Exam / Course" />,
        cell: ({ row }) => {
            const assignment = row.original;
            return (
                <div className="flex flex-col">
                    <span>{assignment.examName}</span>
                    <span className="text-muted-foreground text-xs">{assignment.examId}</span>
                </div>
            );
        },
    },
    {
        ...
        header: ({ column }) => <DataTableColumnHeader column={column} title="Assigned Students" />,
    },
    {
        accessorKey: 'status',
