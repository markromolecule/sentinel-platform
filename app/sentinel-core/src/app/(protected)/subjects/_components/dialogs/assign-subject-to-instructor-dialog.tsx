...
function DialogDescriptionText({
    ...
    if (Array.isArray(subjectOfferingId)) {
        return (
            <>
                ...
                to an instructor. They will be automatically enrolled and granted teaching access to
                the associated classrooms.
            </>
        );
    }
    ...
    return (
        <>
            ...
            to an instructor. They will be automatically enrolled and granted teaching access to the
...
export function AssignSubjectToInstructorDialog({
    ...
    const handleSelectInstructor = React.useCallback(
        (val: string | null) => {
            ...
            if (found) {
                ...
                const name =
                    [found.firstName, found.lastName].filter(Boolean).join(' ') || found.email;
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="border-border/70 flex max-h-[90vh] w-full max-w-md flex-col overflow-hidden bg-white p-0 dark:bg-zinc-950">
                ...
                <DialogFooter className="border-border/70 bg-muted/10 border-t px-5 py-3 sm:justify-end">
                    <div className="flex w-full flex-col-reverse gap-2 sm:w-auto sm:flex-row sm:items-center">
                        ...
                        <Button
                            ...
                            className="rounded-lg bg-[#323d8f] px-4 font-medium text-white hover:bg-[#323d8f]/90"
                        >
