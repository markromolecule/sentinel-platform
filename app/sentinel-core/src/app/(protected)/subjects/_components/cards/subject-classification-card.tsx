    ...
    return (
        <>
            <div className="group relative h-full min-w-0">
                ...
                >
                    <Card className="border-border/60 hover:border-border/80 flex h-full min-h-[120px] min-w-0 flex-col overflow-hidden py-0 shadow-xs transition-all duration-200 hover:shadow-md">
