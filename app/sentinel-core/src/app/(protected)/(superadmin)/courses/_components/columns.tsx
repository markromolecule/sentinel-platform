...
import { CourseDepartmentCell } from "@/app/(protected)/(superadmin)/courses/_components/course-department-cell";
import { CourseActionsCell } from "@/app/(protected)/(superadmin)/courses/_components/course-actions-cell";
