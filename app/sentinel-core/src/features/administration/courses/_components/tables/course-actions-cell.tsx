...
import { CourseSectionsDialog } from '../dialogs/course-sections-dialog';
...
/**
 * CourseActionsCell rendering the dynamic dropdown action cell in the courses table.
 * Integrates capability-aware permissions to hide or show local override and delete items.
 */
