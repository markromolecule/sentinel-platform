...
/**
 * CourseDepartmentCell component to display the department code or name associated with a course.
 */
export function CourseDepartmentCell({
    departmentId,
    departmentName,
    departmentCode,
}: CourseDepartmentCellProps) {
    ...
    return <div>{department ? department.code : isLoading ? '...' : departmentId}</div>;
}
