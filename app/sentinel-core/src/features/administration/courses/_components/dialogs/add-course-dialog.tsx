...
import { useAddCourseForm } from '@/features/administration/courses/hooks/use-add-course-form';
import { useAcademicScope } from '@/hooks/use-academic-scope';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@sentinel/ui';

/**
 * AddCourseDialog component that renders a dialog form to create new academic courses.
 * It gates visibility based on capability permissions and locks fields based on academic scope.
 */
export function AddCourseDialog() {
    ...
    const { assignedDepartmentId, shouldLockDepartment, isReadOnlyFor } = useAcademicScope();
    ...
    if (!hasPermission('courses:create') || isCoursesReadOnly) {
        return null;
    }
