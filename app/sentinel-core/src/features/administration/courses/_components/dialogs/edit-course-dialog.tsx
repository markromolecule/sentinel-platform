...
import { useEditCourseForm } from '@/features/administration/courses/hooks/use-edit-course-form';
...
/**
 * EditCourseDialog component to modify details of a course. Handles branch-level local overrides and locks.
 */
