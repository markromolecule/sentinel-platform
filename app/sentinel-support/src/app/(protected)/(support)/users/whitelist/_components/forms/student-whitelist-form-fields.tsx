...
import { StudentWhitelistFormValues } from '@/app/(protected)/(support)/users/whitelist/_hooks/use-student-whitelist-form';
...
/**
 * Renders the form fields for creating or editing student whitelist records.
 */
