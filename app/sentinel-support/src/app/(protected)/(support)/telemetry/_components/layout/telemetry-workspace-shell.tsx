...
import { TelemetryNav, type TelemetrySection } from './telemetry-nav';
import { Separator } from '@sentinel/ui';

type TelemetryWorkspaceShellProps = {
    activeSection: string;
    onActiveSectionChange: (id: TelemetrySection) => void;
    children: ReactNode;
};

export function TelemetryWorkspaceShell({
    activeSection,
    onActiveSectionChange,
    children,
}: TelemetryWorkspaceShellProps) {
    return (
