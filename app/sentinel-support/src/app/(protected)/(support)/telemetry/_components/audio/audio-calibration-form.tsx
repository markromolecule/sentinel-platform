        ...
        <Card className="w-full border-primary/10 overflow-hidden py-0">
            <CardHeader className="bg-muted/30 border-b py-5">
                ...
                <CardDescription className="text-xs">
                    Configure global sensitivity, consecutive frame evaluation parameters, and individual
                    anomaly confidence thresholds for the real-time audio analytics engine.
                </CardDescription>
            </CardHeader>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                <div className="space-y-4">
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="bg-muted/30 rounded-xl border p-4">
                                                ...
                                                <FormDescription className="text-xs leading-normal">
                                                    Adjusts all thresholds proportionally. Lower value = more sensitive. (0.5 to 2.0)
                                                </FormDescription>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-xs font-semibold">Consecutive Frame Threshold</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            type="number"
                                                            min={1}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-xs font-semibold">Cooldown (seconds)</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            type="number"
                                                            min={1}
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-muted-foreground text-xs leading-relaxed">
                                            Baseline confidence thresholds (0.0 to 1.0). The effective sensitivity is adjusted dynamically in response to your Global Sensitivity Multiplier.
                                        </p>
                                    </div>

                                    <div className="bg-muted/10 rounded-xl border p-5 space-y-6">
                                        {AUDIO_ANOMALY_TYPES.map((type) => (
                                            <FormField
                                                key={type}
                                                control={form.control}
                                                        ...
                                                        <div className="flex items-center justify-between">
                                                            <span className="text-sm font-semibold capitalize text-foreground/90">
                                                             ...
                                                             <div className="flex items-center gap-2">
                                                                <span className="bg-muted text-muted-foreground rounded px-1.5 py-0.5 text-[10px] font-medium border">
                                                                    Base {field.value.toFixed(2)}
                                                                </span>
                                                                <span className="bg-blue-500/10 text-[#323d8f] dark:bg-blue-500/20 dark:text-blue-300 rounded px-1.5 py-0.5 text-[10px] font-bold border border-[#323d8f]/20">
                                                                    Effective {Math.min(
                                                                        1,
                                                                        Math.max(
                                                                            0,
                        ...
                        <div className="flex justify-end gap-4 pt-2">
                            ...
                            <Button
                                type="submit"
                                disabled={isPending}
                                className="bg-[#323d8f] hover:bg-[#323d8f]/90 h-10 min-w-[120px] text-xs font-semibold text-white shadow-sm"
                            >
            ...
            {record?.updatedAt && (
                <CardFooter className="bg-muted/30 text-muted-foreground border-t justify-between py-3 text-xs">
                    <span>
