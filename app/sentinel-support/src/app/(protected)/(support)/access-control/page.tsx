...
export default function AccessControlOverviewPage() {
    ...
    const controlCenterItems = useStableValue(
        () => [
            [
                'System roles',
    ...
    const workspaceItems = useStableValue(
        () => [
            {
        ...
        [overview?.totalAssignments, permissions.length, roles.length, settings?.updatedAt],
    );

    const examDefaultRows = useStableValue(
        () => [
            ['Duration', `${settings?.value.defaultDurationMinutes ?? 0} minutes`],
                ...
                <div className="grid gap-8">
                        ...
                        <section className="space-y-4">
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm">
                                    A quick health read on the RBAC layer before you drill into
                                    configuration.
                                </p>
                            </div>

                            <div className="divide-y border-y">
                                {controlCenterItems.map(([label, value, detail]) => (
                                    <div
                                        key={label}
                        ...
                        <section className="space-y-4">
                            <div className="flex items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Every area below is editable so support can actively manage
                                        coverage.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="grid gap-8 xl:grid-cols-[1.1fr_0.9fr]">
                        <section className="space-y-4">
                            <div className="flex items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        The default role posture aligned to platform
                                        responsibilities.
                                    </p>
                                </div>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="divide-y border-y">
                                {examDefaultRows.map(([label, value]) => (
                                    <div
                                        key={label}
                                        className="flex items-center justify-between gap-4 py-4"
                                    >
