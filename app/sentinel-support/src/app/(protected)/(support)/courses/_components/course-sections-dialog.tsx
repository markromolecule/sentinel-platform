...
import { SectionFormFields } from '../../sections/_components/section-form-fields';
...
export function CourseSectionsDialog({
    ...
    const onSubmit: SubmitHandler<SectionFormValues> = (values) => {
        const payload = {
            ...
            course_id: courseId, // Ensure it's locked to this course
        };
                        ...
                        <Form {...form}>
                            ...
                            >
                                <SectionFormFields
                                    ...
                                    courses={[]} // Not needed as course is fixed
