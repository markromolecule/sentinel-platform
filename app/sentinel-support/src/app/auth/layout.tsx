...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="dark text-foreground relative min-h-screen overflow-hidden bg-[#0f0f10]">
            ...
            <div className="pointer-events-none absolute top-20 left-1/2 h-48 w-48 -translate-x-1/2 rounded-full bg-[rgba(70,84,233,0.18)] blur-3xl" />
