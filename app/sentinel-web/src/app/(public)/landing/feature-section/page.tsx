                    ...
                    <div className="relative z-10 grid gap-4 lg:grid-cols-3">
                        {FEATURE_ITEMS.map((feature, index) => (
                            ...
                            >
                                ...
                                <div>
                                    <p className="mb-8 text-[0.9rem] font-medium tracking-[0.26em] text-white/28 uppercase">
                                        {String(index + 1).padStart(2, '0')}
                                    </p>
                                    <h3 className="max-w-[12rem] text-[2.7rem] leading-[0.94] font-semibold tracking-[-0.055em] text-white">
                                        {feature.title}
                                    </h3>
                                </div>

                                <div className="space-y-7">
                                    <p className="max-w-[17rem] text-[1rem] leading-7 text-white/68">
                                        {feature.description}
                                    </p>
                                    <div className="h-px w-full bg-[linear-gradient(90deg,rgba(70,84,233,0.26),rgba(255,255,255,0.04),transparent)]" />
                                    <p className="text-sm font-medium tracking-[0.24em] text-white/48 uppercase">
                                        {feature.stat}
                                    </p>
                                </div>
                            </motion.article>
