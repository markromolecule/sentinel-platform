    ...
    return (
        <main className="relative isolate overflow-hidden bg-[#080807] text-[#f6f4ee]">
            <motion.div
                ...
                style={{ scaleX }}
            />
            <div className="pointer-events-none fixed inset-0 z-[-1] opacity-[0.08] [background-image:linear-gradient(to_right,#fff_1px,transparent_1px),linear-gradient(to_bottom,#fff_1px,transparent_1px)] [background-size:64px_64px]" />
