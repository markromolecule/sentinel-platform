...
const platformCards = [
    {
        ...
        description:
            'Launch secure sessions, verify device readiness, and stay monitored from check-in to submit.',
        icon: Smartphone,
    ...
    },
    {
        ...
        description:
            'Give students the same monitored experience on iPhone with guided setup and cleaner onboarding.',
        icon: Apple,
        ...
        >
            <div className="relative z-10 grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
                <div className="space-y-6">
                    <div className="inline-flex items-center gap-2 border border-white/10 bg-white/[0.03] px-3 py-2 text-[11px] tracking-[0.32em] text-white/60 uppercase">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="max-w-lg text-base leading-7 text-white/[0.6] md:text-lg">
                            Keep the hero’s momentum going with direct platform choices. Android and
                            iOS both lead into the same Sentinel exam experience.
                        </p>
                    </div>
                    ...
                    <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-5 text-white/[0.74]">
                        ...
                        <p className="text-sm leading-6">
                            Device check, guided permissions, gaze monitoring, audio anomaly checks,
                            and a smoother path into every protected assessment.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid gap-4">
                    {platformCards.map(
                        ({ platform, title, description, icon: Icon, accent, href }) => (
                            <Link
                                key={platform}
                                href={href}
                            ...
                            >
                                <div
                                    className={`flex size-14 items-center justify-center rounded-2xl ${accent}`}
                                >
                                    <Icon className="size-6" />
                                </div>

                                <div className="space-y-1">
                                    <p className="text-xs tracking-[0.32em] text-white/[0.45] uppercase">
                                        {platform}
                                    </p>
