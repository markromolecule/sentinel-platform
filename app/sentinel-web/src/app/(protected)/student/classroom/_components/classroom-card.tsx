                ...
                <CardContent className="p-4">
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-start justify-between">
                            <div className="bg-primary/10 text-primary flex h-10 w-10 items-center justify-center rounded-none transition-colors group-hover:bg-primary group-hover:text-white">
                        ...
                        <div className="space-y-0.5">
                            <h3 className="line-clamp-1 text-base font-bold group-hover:text-primary transition-colors">
                        ...
                        <div className="border-border/50 mt-1 flex flex-col gap-1.5 border-t pt-3">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-muted-foreground text-xs">{classroom.term}</span>
                            </div>
                        </div>
                    </div>
                </CardContent>
