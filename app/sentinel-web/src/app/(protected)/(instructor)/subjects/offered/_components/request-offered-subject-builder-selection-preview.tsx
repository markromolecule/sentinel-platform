interface RequestOfferedSubjectBuilderSelectionPreviewProps {
    title: string;
    items: string[];
    emptyLabel: string;
    accent?: boolean;
...
export function RequestOfferedSubjectBuilderSelectionPreview({
    title,
    items,
    emptyLabel,
    accent = false,
    visibleLimit = 3,
}: RequestOfferedSubjectBuilderSelectionPreviewProps) {
    return (
        <div
