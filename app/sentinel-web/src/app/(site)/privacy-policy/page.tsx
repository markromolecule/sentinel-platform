            ...
            <div className="relative z-10 container mx-auto max-w-4xl px-6">
                ...
                <div className="prose prose-invert prose-lg max-w-none text-gray-300">
                    <p>
                        ...
                        collect, use, disclosure, and safeguard your data when you use our
                    ...
                    <p>
                        ...
                        Philippines. We are dedicated to upholding your rights as a data subject,
                        including your right to be informed, to object, to access, to rectification,
                        to erasure or blocking, and to damages.
                    </p>
                    <p>
                        All personal data collected is processed in accordance with the general
                    ...
                    <p>
                        To provide our examination monitoring services, we may collect the following
                        types of information:
                    </p>
                    <ul className="list-disc space-y-2 pl-6 text-gray-400">
                        <li>
                            <strong>Personal Information:</strong> Name, student ID, email address,
                            and institutional affiliation.
                        </li>
                        <li>
                            <strong>Biometric Data:</strong> Facial data for gaze tracking and
                            identity verification during exam sessions.
                        </li>
                        <li>
                            <strong>Audio Data:</strong> Audio recordings from your microphone
                            during the exam environment monitoring.
                        </li>
                        <li>
                            <strong>Device Information:</strong> Device type, operating system, and
                            browser version used to access the system.
                        </li>
                    </ul>
                    ...
                    <ul className="list-disc space-y-2 pl-6 text-gray-400">
                        ...
                        <li>
                            Monitoring exam sessions for potential academic dishonesty (e.g.,
                            unauthorized looking away, unauthorized voices).
                        </li>
                    ...
                    <p>
                        ...
                        information is encrypted in transit and at rest. Access to exam recordings
                        and reports is strictly limited to authorized proctors and administrators of
                        your institution.
                    </p>
                    ...
                    <p>
                        ...
                        <a
                            href="mailto:privacy@sentinel.edu"
                            className="text-blue-400 transition-colors hover:text-blue-300"
                        >
                            privacy@sentinel.edu
                        </a>
                        .
                    </p>
                </div>
