...
export const metadata: Metadata = {
    ...
    description:
        "Sentinel is a mobile and web platform for securing online exams, monitoring student focus, and preventing academic dishonesty. It's built for educators, ensuring fair testing everywhere.",
    openGraph: {
                            ...
                            '@graph': [
                                {
                                    ...
                                    potentialAction: {
                                        ...
                                        target: {
                                            '@type': 'EntryPoint',
                                            urlTemplate:
                                                'https://www.sentinelph.tech/search?q={search_term_string}',
                                        },
