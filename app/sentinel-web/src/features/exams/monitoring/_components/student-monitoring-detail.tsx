    ...
    return (
        <div className="mx-auto flex h-[calc(100vh-10rem)] w-full max-w-7xl flex-col gap-5 overflow-hidden px-4 pb-4">
            ...
            <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[1fr] gap-6 overflow-hidden lg:grid-cols-12">
                ...
                <div className="scrollbar-thin scrollbar-thumb-border/70 hover:scrollbar-thumb-border flex min-h-0 flex-col gap-4 overflow-y-auto pr-2 lg:col-span-4">
                ...
                <div className="scrollbar-thin scrollbar-thumb-border/70 hover:scrollbar-thumb-border min-h-0 overflow-y-auto pr-2 lg:col-span-8">
