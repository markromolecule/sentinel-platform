...
import { useExamConfigForm } from "../_hooks/use-exam-config-form";
import { DeviceHardwareSection } from "./device-hardware-section";
...
export function ExamConfigForm({ defaultValues }: ExamConfigFormProps) {
    ...
    return (
        <Form {...form}>
            <form id="proctor-config-form" onSubmit={form.handleSubmit(onSubmit)}>
                <Card>
