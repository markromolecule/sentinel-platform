...
interface DeleteEventConfirmDialogProps {
    ...
    /** Title of the event/note to be deleted — shown in the description. */
    eventTitle: string;
...
/**
 * A confirmation alert dialog shown before a calendar event or personal note is deleted.
        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent>
                ...
                <AlertDialogFooter>
                    ...
                    {/* Primary accent matches sentinel-web brand blue */}
                    <AlertDialogAction
                        onClick={onConfirm}
                        disabled={isDeleting}
