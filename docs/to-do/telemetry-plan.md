...
and also 2. Sandbox (MediaPipe) here we can configure the mediapipe gaze tracking. In that way we can use that later to integrate on the [checkup] page on the student and let the instructor now get the [event] related to gaze
