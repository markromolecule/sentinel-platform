...
- **[Git Workflow](standard/git-workflow.md)**
  Codifies strict repository collaboration patterns mandating _Conventional Commits_ requirements regarding phrasing (`feat`, `fix`), branching behaviors, and automated dependencies (`Dependabot`).
