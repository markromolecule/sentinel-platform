...
**Why it's needed:** Isolates all database interactions. Tests, Controllers, and Services don't need to know _how_ to query the database, they just call a data function. It centralizes SQL queries, making schema updates, query optimization, and database migrations significantly easier to manage.
