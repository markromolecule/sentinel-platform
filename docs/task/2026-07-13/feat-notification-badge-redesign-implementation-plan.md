...
- Wrap `<Bell />` and its badge span in a `relative` wrapper div, and update the badge styling:
  ...
  <div className="relative">
      ...
      {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1.5 flex h-3.5 min-w-3.5 items-center justify-center rounded-full bg-destructive px-0.5 text-[8px] font-bold leading-none text-destructive-foreground ring-2 ring-background shadow-sm animate-in fade-in zoom-in-75 duration-200">
