...
*Tradeoff*: Couples unrelated modules; leaks access-control-specific types into the identity module.
...
*Tradeoff*: Slightly more files to create, but properly scoped and fully maintainable.
...
*Tradeoff*: Most reusable long-term, but requires touching `packages/ui` which is shared across all apps — higher risk for this fix.
