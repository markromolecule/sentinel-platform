...
You can start applying this from sentinel-support pages such as 
    - Institutions
    - Departments
    - Courses
    - Sections
...
Next phase will be focused on sentinel-core for later
    - Departments
    - Rooms
    - Semesters
    - Analytics
    ...
    - Logs
    - Messages
    - Question bank, Question Collection, TOS Matrix, Import
    - Sections
    - Subjects
