...
- To ensure that the [exam] is publicly available within the [institution] and not outside the institution such as the other branches

- UI update for the exam page in sentinel-web
    - remove the icon on the sidebar layout of the exam paage
...
- Improve the UX for the selection on the exam page for [all, published, drafts, archived] ensure to provide a better ux for the user more clean, compact, and neat ui
    - this applies both sentinel-core and sentinel-web

- In instructor sidebar add a separator between the students and exams in that way the exams and question bank are separated to the students sub item
